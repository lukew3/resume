...
\AddToShipoutPictureBG{%
  \AtTextLowerLeft{%
    \raisebox{-1cm}{\makebox[\paperwidth][r]{\textsf{\small \textcolor[rgb]{0.8,0.8,0.8}{https://github.com/lukew3/resume v1.10.3}}\hspace{3cm}}}%
  }%
}
...
\vspace{1mm}
    ...
    \begin{itemize} \itemsep -1mm
            ...
            % \item Added a portfolio of features to a new regulatory reporting application using React and Java Spring Boot on top of an Oracle SQL database, expanding the app's functionality for a previously unserviced user group.
    ...
    \begin{itemize} \itemsep -1mm
            ...
            % \item Streamlined the manual process of determining a customers eligibility of lease to loan conversion with 1600 requests processed to date with 0 production defects.
    ...
    \begin{itemize} \itemsep -1mm
            ...
            % \item Reformed issue management 

            % \item Reduced application tech-debt through refactoring
        
            % \item Delivered a multitude of assorted features and bug fixes for the OpenOndemand platform, empowering researchers to seamlessly interface with Linux supercomputers through a user-friendly web interface.
    ...
    \begin{itemize} \itemsep -1mm
            ...
            % \item Created a fast and efficient data storage system for over 100k unique users every day by architecting and implementing the MongoDB database, Express.js backend API, and connecting client code for monkeytype.com.
        
            % \item Reduced operating costs by 70 percent and slowed the rate of increasing cloud service costs by identifying and correcting inefficient system architecture and processes.
...
\header{Projects}
    ...
    \begin{itemize} \itemsep -1pt
        ...
        \item Created CI pipelines using Github Actions to ensure stability through automated code testing and linting
            % Created and maintain an open-source Python package that enables generating a wide variety of math exercises. Featured on YC Hacker News, reaching rank 3 on the front page. Has over 300 downloads per month and over 500 stars on Github.\\
