...
\AddToShipoutPictureBG{%
  \AtTextLowerLeft{%
    \raisebox{-1cm}{\makebox[\paperwidth][r]{\textsf{\small \textcolor[rgb]{0.8,0.8,0.8}{https://github.com/lukew3/resume v2.0.4}}\hspace{3cm}}}%
  }%
}
...
\begin{tabular}{ l l }
    ...
    \textbf{Programming Languages:} Python, Javascript, Java, C/C++, Ruby, HTML/CSS, SQL, Go, Rust, x86 assembly, Dart  \\

    \textbf{Frameworks:} React, Spring Boot, Rails, Flask, Django, Express.js, Next.js, Redux, Flutter  \\
